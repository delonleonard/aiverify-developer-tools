...
class Plugin(IAlgorithm):
    ...
    The Plugin(grad_cam) class specifies methods in generating results for algorithm
    """

    # Some information on plugin
    _name: str = "grad_cam"
    _description: str = "Grad-CAM (Gradient-weighted Class Activation Mapping) is used for classifiers to visualize the important regions in an input that influenced the classifier's decision-making process."
    _version: str = "0.1.0"
